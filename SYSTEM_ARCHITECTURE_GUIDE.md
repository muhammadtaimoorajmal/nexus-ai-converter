...
* You will create a free account on their website, and they will give you a "Connection String" (a URL that looks like `mongodb+srv://admin:password@cluster0.mongodb.net`).
