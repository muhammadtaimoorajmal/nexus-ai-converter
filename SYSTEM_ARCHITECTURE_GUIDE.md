...
* You will create a free account on their website, and they will give you a "Connection String" (a URL that looks like `mongodb+srv://YOUR_USERNAME:YOUR_PASSWORD@YOUR_CLUSTER.mongodb.net`).
